...
#	tar hcf /tmp/results_${test_name}_${to_tuned_setting}.tar results_${test_name}_${to_tuned_setting}
	${curdir}/test_tools/save_results --curdir $curdir --home_root $to_home_root --copy_dir ${test_name}_${to_tuned_setting} --test_name $test_name --tuned_setting=$to_tuned_setting --version NONE --user $to_user
fi
